...
divide_init( void *context )
{
  ...
  divide_idechn0 = libspectrum_ide_alloc( libspectrum_context, LIBSPECTRUM_IDE_DATA16 );
  divide_idechn1 = libspectrum_ide_alloc( libspectrum_context, LIBSPECTRUM_IDE_DATA16 );
