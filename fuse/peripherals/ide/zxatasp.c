...
zxatasp_init( void )
{
  ...
  zxatasp_idechn0 = libspectrum_ide_alloc( libspectrum_context, LIBSPECTRUM_IDE_DATA16 );
  zxatasp_idechn1 = libspectrum_ide_alloc( libspectrum_context, LIBSPECTRUM_IDE_DATA16 );
